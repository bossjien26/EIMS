...
{
    [TestFixture]
    public class ItemRepositoryTest : BaseRepositoryTest
    {
        private readonly IItemRepository _repository;

        public ItemRepositoryTest() => _repository = new ItemRepository(_context);

        [Test]
        async public Task ShouldGet()
        {
            var testData = ItemSeeder.SeedOne();
        ...
        {
            await _repository.InsertMany(ItemSeeder.SeedMany(5, 5));
